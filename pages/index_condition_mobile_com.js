...
export default function Home() {
  ...
  return (
    ...
    {/* The first div with the class md:hidden will be hidden on screens medium (md) and larger, meaning it will only be visible on small screens (e.g., mobile screens). */}

{/* The second div with the class hidden md:block will be hidden on small screens (e.g., mobile screens) and will only be visible on medium screens and larger (e.g., computer screens). */}
    <div className="text-white md:hidden" >mobile</div>
